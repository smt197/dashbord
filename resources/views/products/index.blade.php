@extends('layouts.app')
  
@section('title', 'Home voiture')
  
@section('contents')
    <div class="d-flex align-items-center justify-content-between">
        <h1 class="mb-0">Liste des voitures</h1>
        <a href="{{ route('products.create') }}" class="btn btn-primary">Add Vehicule</a>
    </div>
    <hr />
...
                        <td class="align-middle">{{ $rs->nbr_place }}</td>
                        <td class="align-middle">{{ $rs->description }}</td>
                        <td class="align-middle">{{ $rs->fabricant }}</td>  
                        <td class="align-middle">{{ $rs->modele }}</td>  
                        <td class="align-middle">{{ $rs->date_fabrication }}</td>  
                        <td class="align-middle">{{ $rs->couleur }}</td>  
